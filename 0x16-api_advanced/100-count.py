...
def count_words(subreddit, word_list, after=None, sort=True):
    """
    Query Reddit API and parse the title of all the hot articles,
    and print the selected count for keywords (case-insensitive, delimited
    by spaces. Javascript is considered javascript, but java should not)
    Ags:
